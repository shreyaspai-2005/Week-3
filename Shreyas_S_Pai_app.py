...
#To run the app, open Terminal and navigate to the directory where the app.py is saved.
#For example, if the app is saved in the folder named 'Plant Disease Detection System_Project - Edunet Foundation', then run the following command: 
# cd "C:\Users\Coding\Desktop\PythonProject\Plant Disease Detection System_Project - Edunet Foundation"    
#run the following command: streamlit run Shreyas_S_Pai_app.py
#We can  now do prediction.